...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/SAKSHAMJAINN01/ai-resume-builder.git
   ```
...
For any questions or feedback, please open an issue on the [GitHub repository](https://github.com/SAKSHAMJAINN01/ai-resume-builder/issues).
